    ...
    <>
      <div className={`space-y-8 ${moodTheme.background} min-h-screen -m-8 p-8`}>
        ...
        <div className={`text-center py-8 bg-gradient-to-br ${moodTheme.secondary} rounded-2xl border-2 border-white/50 backdrop-blur-sm`}>
          ...
          {/* Mood Indicator */}
          {currentMood !== 'neutral' && (
            <div className={`mt-4 inline-flex items-center space-x-2 px-4 py-2 bg-white/70 backdrop-blur-sm rounded-full border border-white/50`}>
          ...
          {profile?.streak_count && profile.streak_count > 0 && (
            <div className="mt-4 inline-flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-orange-100 to-red-100 rounded-full border border-orange-200 ml-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-xl border border-white/50 hover:shadow-lg transition-all duration-200 hover:bg-white/90">
        ...
        {/* Today's Focus Orbit */}
        <div className="bg-white/80 backdrop-blur-sm p-8 rounded-xl border border-white/50">
          ...
          {focusTasks.length > 0 ? (
            <div className="space-y-4">
              {focusTasks.map((task, index) => (
                <div
                  key={task.id}
                  className={`flex items-center space-x-4 p-4 bg-gradient-to-r ${moodTheme.secondary} rounded-lg border border-white/50 backdrop-blur-sm hover:bg-white/70 transition-all duration-200`}
                >
            ...
            <div className="flex items-center justify-center py-12 border-2 border-dashed border-gray-300 rounded-lg bg-white/50">
