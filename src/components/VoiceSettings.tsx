  ...
  return (
    <div className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
      <div className="flex items-center space-x-3 mb-4">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Voice Assistant</h3>
            ...
            <button
              ...
              className={`w-full text-left p-3 rounded-lg border transition-all duration-200 ${
                selectedVoice?.name === voice.name
                  ...
                  : 'border-gray-200 dark:border-gray-600 hover:border-purple-200 dark:hover:border-purple-700 hover:bg-purple-25 dark:hover:bg-purple-900/10'
              }`}
            >
              <div className="flex items-center justify-between">
                <div>
      ...
      <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
        <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">Voice Features</h4>
